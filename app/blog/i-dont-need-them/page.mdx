export const metadata = {
  ...
  date: "2024-06-28",
  description: "I don't Need Them. Read more on the FTO newsletter.",
  keywords: ["don't", "need", "them", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/i-dont-need-them",
  openGraph: {
    title: "I don't Need Them",
    description: "I don't Need Them. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/i-dont-need-them",
    images: [{ url: "/images/blog/i-dont-need-them/" }],
  },
};
