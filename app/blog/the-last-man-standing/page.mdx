export const metadata = {
  ...
  date: "2024-02-23",
  description: "The Last Man Standing. Read more on the FTO newsletter.",
  keywords: ["last", "standing", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/the-last-man-standing",
  openGraph: {
    title: "The Last Man Standing",
    description: "The Last Man Standing. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/the-last-man-standing",
    images: [{ url: "/images/blog/the-last-man-standing/" }],
  },
};
