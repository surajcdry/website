export const metadata = {
  ...
  date: "2025-07-18",
  description: "Disconnected Yet Connected. Read more on the FTO newsletter.",
  keywords: ["disconnected", "connected", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/disconnected-yet-connected",
  openGraph: {
    title: "Disconnected Yet Connected",
    description: "Disconnected Yet Connected. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/disconnected-yet-connected",
    images: [{ url: "/images/blog/disconnected-yet-connected/" }],
  },
};
