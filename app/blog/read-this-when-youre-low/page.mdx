export const metadata = {
  ...
  date: "2024-05-31",
  description: "Read This When you're Low. Read more on the FTO newsletter.",
  keywords: ["read", "when", "you're", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/read-this-when-youre-low",
  openGraph: {
    title: "Read This when you're Low",
    description: "Read This When you're Low. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/read-this-when-youre-low",
    images: [{ url: "/images/blog/read-this-when-youre-low/" }],
  },
};
