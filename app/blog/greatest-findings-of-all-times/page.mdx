export const metadata = {
  ...
  date: "2025-02-28",
  description: "Greatest Findings Of All Times. Read more on the FTO newsletter.",
  keywords: ["greatest", "findings", "times", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/greatest-findings-of-all-times",
  openGraph: {
    title: "Greatest Findings of All Times",
    description: "Greatest Findings Of All Times. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/greatest-findings-of-all-times",
    images: [{ url: "/images/blog/greatest-findings-of-all-times/" }],
  },
};
