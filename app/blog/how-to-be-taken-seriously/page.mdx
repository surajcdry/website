export const metadata = {
  ...
  date: "2025-11-21",
  description: "How To Be Taken Seriously. Read more on the FTO newsletter.",
  keywords: ["taken", "seriously", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/how-to-be-taken-seriously",
  openGraph: {
    title: "How to Be Taken Seriously",
    description: "How To Be Taken Seriously. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/how-to-be-taken-seriously",
    images: [{ url: "/images/blog/how-to-be-taken-seriously/" }],
  },
};
