export const metadata = {
  title: "Procrastinate to Win",
  date: "2023-04-14",
  description: "Procrastinate To Win. Read more on the FTO newsletter.",
  keywords: ["procrastinate", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/procrastinate-to-win",
  openGraph: {
    title: "Procrastinate to Win",
    description: "Procrastinate To Win. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/procrastinate-to-win",
    images: [{ url: "/images/blog/procrastinate-to-win/" }],
  },
};
