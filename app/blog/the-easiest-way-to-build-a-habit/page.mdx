export const metadata = {
  ...
  date: "2024-03-22",
  description: "The Easiest Way To Build A Habit. Read more on the FTO newsletter.",
  keywords: ["easiest", "build", "habit", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/the-easiest-way-to-build-a-habit",
  openGraph: {
    title: "The Easiest Way to Build a Habit",
    description: "The Easiest Way To Build A Habit. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/the-easiest-way-to-build-a-habit",
    images: [{ url: "/images/blog/the-easiest-way-to-build-a-habit/" }],
  },
};
