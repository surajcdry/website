export const metadata = {
  ...
  date: "2025-02-07",
  description: "Where Ideas Come From. Read more on the FTO newsletter.",
  keywords: ["where", "ideas", "come", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/where-ideas-come-from",
  openGraph: {
    title: "Where Ideas Come From",
    description: "Where Ideas Come From. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/where-ideas-come-from",
    images: [{ url: "/images/blog/where-ideas-come-from/" }],
  },
};
