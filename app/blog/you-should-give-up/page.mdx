export const metadata = {
  ...
  date: "2024-06-14",
  description: "Learn why giving up on things that don't serve you is sometimes the best decision. Understand the sunk-cost fallacy and when to let go.",
  keywords: ["should", "give", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/you-should-give-up",
  openGraph: {
    title: "You Should Give Up",
    description: "Learn why giving up on things that don't serve you is sometimes the best decision. Understand the sunk-cost fallacy and when to let go.",
    url: "https://surajc.com/blog/you-should-give-up",
    images: [{ url: "/images/blog/you-should-give-up/" }],
  },
};
...
There's a concept called the "sunk-cost fallacy." (Thank you [Prajwal](https://www.prajwalthapa.com.np) for telling me about this.)
