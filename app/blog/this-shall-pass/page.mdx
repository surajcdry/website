export const metadata = {
  ...
  categories: ["FTO"],This shall pass\" – How to deal with hard times",
  openGraph: {
    title: "\"This shall pass\" – How to deal with hard times",
    description: "Blog post",
    images: [{ url: "/images/blog/this-shall-pass/this-shall-pass-scaled.jpeg" }],
  },
};
