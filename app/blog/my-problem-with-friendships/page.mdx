export const metadata = {
  ...
  date: "2025-09-19",
  description: "My Problem With Friendships. Read more on the FTO newsletter.",
  keywords: ["problem", "friendships", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/my-problem-with-friendships",
  openGraph: {
    title: "My Problem With Friendships",
    description: "My Problem With Friendships. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/my-problem-with-friendships",
    images: [{ url: "/images/blog/my-problem-with-friendships/" }],
  },
};
