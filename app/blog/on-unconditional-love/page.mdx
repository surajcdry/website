export const metadata = {
  ...
  date: "2026-01-09",
  description: "On Unconditional Love. Read more on the FTO newsletter.",
  keywords: ["unconditional", "love", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/on-unconditional-love",
  openGraph: {
    title: "On Unconditional Love",
    description: "On Unconditional Love. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/on-unconditional-love",
    images: [{ url: "/images/blog/on-unconditional-love/" }],
  },
};
