export const metadata = {
  ...
  date: "2025-08-29",
  description: "Things That We Leave Behind. Read more on the FTO newsletter.",
  keywords: ["things", "leave", "behind", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/things-that-we-leave-behind",
  openGraph: {
    title: "Things That We Leave Behind",
    description: "Things That We Leave Behind. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/things-that-we-leave-behind",
    images: [{ url: "/images/blog/things-that-we-leave-behind/" }],
  },
};
