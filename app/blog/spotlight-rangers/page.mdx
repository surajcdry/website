export const metadata = {
  ...
  date: "2022-05-29",
  description: "Spotlight Rangers. Read more on the FTO newsletter.",
  keywords: ["spotlight", "rangers", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/spotlight-rangers",
  openGraph: {
    title: "Spotlight Rangers",
    description: "Spotlight Rangers. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/spotlight-rangers",
    images: [{ url: "/images/blog/spotlight-rangers/" }],
  },
};
