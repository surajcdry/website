export const metadata = {
  ...
  date: "2024-09-13",
  description: "Little Progress. Read more on the FTO newsletter.",
  keywords: ["little", "progress", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/little-progress",
  openGraph: {
    title: "Little Progress",
    description: "Little Progress. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/little-progress",
    images: [{ url: "/images/blog/little-progress/" }],
  },
};
