export const metadata = {
  title: "Worst That Can Happen",
  date: "2024-03-01",
  description: "Worst That Can Happen. Read more on the FTO newsletter.",
  keywords: ["worst", "happen", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/worst-that-can-happen",
  openGraph: {
    title: "Worst That Can Happen",
    description: "Worst That Can Happen. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/worst-that-can-happen",
    images: [{ url: "/images/blog/worst-that-can-happen/" }],
  },
};
