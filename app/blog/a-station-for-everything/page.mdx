export const metadata = {
  ...
  date: "2024-08-09",
  description: "A Station For Everything. Read more on the FTO newsletter.",
  keywords: ["station", "everything", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/a-station-for-everything",
  openGraph: {
    title: "A Station for Everything",
    description: "A Station For Everything. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/a-station-for-everything",
    images: [{ url: "/images/blog/a-station-for-everything/" }],
  },
};
