export const metadata = {
  ...
  date: "2023-09-02",
  description: "Must You Fit In. Read more on the FTO newsletter.",
  keywords: ["must", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/must-you-fit-in",
  openGraph: {
    title: "Must You Fit in",
    description: "Must You Fit In. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/must-you-fit-in",
    images: [{ url: "/images/blog/must-you-fit-in/" }],
  },
};
