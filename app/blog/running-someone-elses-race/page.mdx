export const metadata = {
  title: "Are you running someone else',
  date: "2024-06-07",
  description: "Blog post",
  categories: ["FTO"],s race?",
  openGraph: {
    title: "Are you running someone else's race?",
    description: "Blog post",
    images: [{ url: "/images/blog/running-someone-elses-race/Are-you-running-someone-elses-race.png" }],
  },
};
