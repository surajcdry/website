export const metadata = {
  ...
  date: "2023-09-21",
  description: "You Need To Stop Learning. Read more on the FTO newsletter.",
  keywords: ["need", "stop", "learning", "fto"],
  categories: ["FTO"],
  canonicalUrl: "https://surajc.com/blog/you-need-to-stop-learning",
  openGraph: {
    title: "You Need to Stop Learning",
    description: "You Need To Stop Learning. Read more on the FTO newsletter.",
    url: "https://surajc.com/blog/you-need-to-stop-learning",
    images: [{ url: "/images/blog/you-need-to-stop-learning/" }],
  },
};
